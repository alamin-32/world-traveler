...
const Tour = ({ tour }) => {
    const { _id, img, rating, name, price, description, area, age, days } = tour
        ...
        <div class="card lg:card-side bg-base-100 my-3 shadow-xl">
            ...
            <div class="card-body">
                ...
                <div className='flex  plan-sum rounded p-1'>
                    ...
                    <h1 className='flex mx-auto font-semibold'><Icon className='mt-1 mr-2' icon="healthicons:ui-user-profile" color="#ffa801" />{age}+</h1>
                ...
                <div class="card-actions mt-5">
                    <button onClick={() => toProductDetails(_id)} class="btn  con-btn">Details</button>
                </div>
            </div>
        </div>
    );
