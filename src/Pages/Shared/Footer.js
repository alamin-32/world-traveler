        ...
        <div>
            <footer class="footer px-10 py-20 f-bg text-base-content">
                <div class="flex flex-col w-full">
                    <div>
                        <Link to='/'><h1 className='text-4xl font-extrabold  text-orange-500'>Global Traveler</h1></Link>
                    ...
                    <div>
                        ...
                        <div className='flex py-2'>
                            ...
                            <p className='f-font ml-2'>needhelp@global.com</p>
                        </div>
                        <div className='flex py-2'>
                            <p className='f-font pt-1 text-2xl'><Icon icon="fa6-solid:location-dot" color="#e8604c" /></p>
                            <p className='f-font ml-2'>16 Indira Rd, Farmgate Dhaka</p>
                        </div>
                    </div>
                </div>
                <div>
